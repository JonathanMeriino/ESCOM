...
public class Vista extends JFrame implements ActionListener
{
	...
	private JButton multiplicacion = new JButton("x");
	private JButton division = new JButton("/");
	private JButton inverso = new JButton("x-1");
	private JButton potencia2 = new JButton("x2");
	private JButton raizCuadrada = new JButton("/2");
	private JButton raizCubica = new JButton("/3");
	private JButton seno = new JButton("sen");
	...
	public void initComponents()
	{
		...
		display.setBounds(10,5,350,40);
		b1.setBounds(10,50,50,50);
		b2.setBounds(70,50,50,50);
		b3.setBounds(130,50,50,50);
		mas.setBounds(190,50,50,50);
		multiplicacion.setBounds(250,50,50,50);

		b4.setBounds(10,110,50,50);
		b5.setBounds(70,110,50,50);
		b6.setBounds(130,110,50,50);
		menos.setBounds(190,110,50,50);
		division.setBounds(250,110,50,50);

		b7.setBounds(10,170,50,50);
		b8.setBounds(70,170,50,50);
		b9.setBounds(130,170,50,50);
		igual.setBounds(190,170,50,50);
		inverso.setBounds(250,170,50,50);

		cE.setBounds(10,230,50,50);
		b0.setBounds(70,230,50,50);
		potencia2.setBounds(130,230,50,50);
		raizCuadrada.setBounds(190,230,50,50);
		raizCubica.setBounds(250,230,50,50);

		seno.setBounds(10,290,55,50);
		coseno.setBounds(75,290,55,50);
		tangente.setBounds(135,290,55,50);
		e.setBounds(195,290,55,50);
		pi.setBounds(255,290,55,50);
